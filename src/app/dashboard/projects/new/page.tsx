  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-2xl shadow-sm border">
        {/* Infos de base */}
        <div>
          <label className="block text-sm font-bold mb-2 text-black">Nom du projet</label>
        ...
        <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl">
          ...
          <label htmlFor="ent" className="font-semibold cursor-pointer text-black">Ce projet est lié à une entreprise déjà créée</label>
        </div>
